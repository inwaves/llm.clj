...
(defn residual-backward
  "Backward pass for residual connection.
  
  Forward: y = x1 + x2
  Backward: The gradient flows equally to both inputs
  ...
  Note: Both gradients are the same matrix since addition splits gradient equally."
  [dout]
  {:dx1 dout :dx2 dout})